...
const ReferralSchema: Schema<IReferral> = new Schema(
  {
    ...
    referringFacilityId: { type: Schema.Types.ObjectId, ref: "Facility" },
    destinationFacilityId: { type: Schema.Types.ObjectId, ref: "Facility", index: true },
    assignedAshaId: { type: Schema.Types.ObjectId, ref: "User", index: true },
