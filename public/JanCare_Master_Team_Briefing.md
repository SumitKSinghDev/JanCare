...
* **Q26: "What happens if a patient deliberately lies or gives false emergency symptoms just to skip the queue and get treated first?"**  
  *Answer*: *"JanCare handles false emergency claims through a **4-Tier Clinical & Behavioral Verification Safeguard**: (1) **Objective Vital-Symptom Triangulation**: Subjective claims are cross-referenced with objective vitals (SpO2, BP, pulse); if normal, CDSS flags a *'Vital-Symptom Discrepancy'* to the doctor; (2) **Rapid 30-Second Doctor Video Filter**: The on-duty doctor visually inspects the patient and demotes false alarms to the routine queue immediately without writing prescriptions in the emergency channel; (3) **Algorithmic Rate-Limiting & ASHA In-Person Gate**: Repeated false triggers lock fast-track skips and mandate **ASHA Doorstep In-Person Validation**; (4) **Statutory Emergency Deterrence**: 108 Ambulance dispatch mandates verified OTP authentication with legal false-alarm disclaimers under Section 182 IPC/BNS."*
* **Q27: "What happens if a rural PHC has 200 patients queued for just 1 Medical Officer? How does JanCare prevent doctor burnout and massive patient delays?"**  
  *Answer*: *"JanCare solves the **200:1 Doctor Overload Crisis** using a **4-Pillar Clinical Throughput & Load-Balancing Architecture**: (1) **Frontline Triage Deflection (~65% Burden Reduced)**: Up to 130 of the 200 patients have mild, self-limiting issues managed by AI Triage + ASHA at doorstep without doctor load; (2) **75% Consultation Time Compression (7 mins → 90 secs)**: CDSS pre-fills vitals, history, and ICD-10 suggestions, allowing 70 clinical patients to be evaluated in <2 hours instead of 14 hours; (3) **District-Wide Virtual Tele-Pooling**: Non-urgent teleconsultations load-balance dynamically across the district doctor pool; (4) **Emergency Priority Preemption**: Critical patients bypass the queue instantly and route to the 24/7 District Emergency channel."*
* **Q28: "What if an illiterate rural patient forgets their appointment time or loses their phone/token slip?"**  
  *Answer*: *"JanCare provides: (1) **ASHA Proactive Follow-Up**: Local ASHA worker receives notifications for village patient slots and visits in person; (2) **Audio Voice Reminders in Marathi/Hindi**: Automated outbound IVR calls inform patients in their native tongue; (3) **Instant UHID Search**: Clinics retrieve lost records instantly by name, village, or biometric ABHA."*
...
* **Q36: "Why is JanCare registration strictly restricted to 10-digit Indian mobile numbers (+91) instead of allowing international formats?"**  
  *Answer*: *"JanCare is purpose-built for the **Government of Maharashtra & Ayushman Bharat Digital Mission (ABDM)** ecosystem: (1) **ABHA / Aadhaar Interoperability**: Indian digital health records bind to a 10-digit mobile number linked with the National Health Authority (NHA) gateway; (2) **TRAI / DLT Regulatory SMS Compliance**: Transactional OTPs and emergency alerts route through Indian telecom gateways which strictly require 10-digit Indian Mobile Numbers (NNP prefixes 6, 7, 8, or 9); (3) **Anti-Spam & Bot Prevention**: Country-locking with `+91` prefix validation prevents international VoIP fraud and phantom registrations."*
